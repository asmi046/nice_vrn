	...
	<main id="main" class="site-main">
		...
		<section class="electrician-services heating-services"> 
			...
			<P>
				...
				В нашей команде имеется постоянный штат квалифицированных электромонтажников имеющих все необходимые допуски и сертификаты. Все работы проводятся согласно ГОСТ 
			...
			<div class="electrician-services__row heating-services__row">
				...
				<div class="heating-card">
					...
					<div class="heating-card__text-block">
						...
						<p>
							Проведем монтаж электрощитов <br>
							любой сложности. Проектирование и подбор <br>
							оборудования
						</p>
						<a href="#" class="heating-card__btn">
							Заказать
