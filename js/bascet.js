...
jQuery(document).ready(function ($) {
	...
	jQuery('.heating-card__btn').click(function (e) {
		e.preventDefault();
		var title = $(this).data('title');
		jQuery('#construct-modal .uniSendBtn').attr('data-title', 'Заявка на расчет стоимости ' + title);
		jQuery('#construct-modal').arcticmodal();
	});
