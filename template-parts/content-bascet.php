							...
							<tr class="cart-item">
								...
								<td class="product-thumbnail">
									<a href="<?php echo get_the_permalink($product); ?>">
										<?php echo get_the_post_thumbnail( $product, "thumbnail"); ?>
									</a>
								</td>
								
								<td class="product-name__wrap">
									<div class="product-name">
										<a href="<?php echo get_the_permalink($product); ?>" class="product-name__link"><h3 class = "bascetTitle"><?php echo get_the_title($product) ?></h3><span class = "bascetTitleComment"><?php if (!$offertype) echo get_text_param($offerid); else echo $offerid; ?></span></a>
									</div>
								</td>
