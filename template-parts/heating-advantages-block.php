			...
			<div class="container">
				...
				<div class="advantages__column d-flex">
					...
					<div class="advantages__item piggy-bank">
						...
						<p>
							От подбора оборудования до 
							стоимости монтажных работ. Мы 
							стремимся предоставить нашим 
							клиентам оптимальные цены
						</p>
					</div>
					...
					<div class="advantages__item timing-icon">
						...
						<p>
							...
							договором сроки. Все 
							проектировочные и монтажные 
							работы будут выполнены четко в
							срок
						</p>
					</div>
